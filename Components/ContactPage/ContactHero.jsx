...
const ContactHero = () => {
  return (
    <section className='flex items-center justify-center relative h-[40svh] text-center px-16 md:px-0'>
      ...
      <div className='flex flex-col gap-3 items-center z-20 text-[#ffffff]'>
