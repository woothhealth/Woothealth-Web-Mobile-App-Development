  ...
  return (
    <section className='py-8'>
        <div className='bg-[#49A5EF] flex flex-col items-center justify-center py-10 px-6 text-center text-[#FFFFFF] md:gap-6 gap-3'>
            <h3 className='md:text-[36px] text-[32px] font-semibold'>
                Find a provider near you
            </h3>
            <Image src='/Mapimg.png' width={200} height={100} alt='Map' className='md:h-30 h-25 w-auto' priority />
            <p className='md:max-w-3xl text-[1rem] md:text-base mb-4'>
