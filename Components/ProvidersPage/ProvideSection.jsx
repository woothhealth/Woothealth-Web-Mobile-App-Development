...
import { FaArrowRight, FaBookOpen, FaSearchLocation } from 'react-icons/fa';
import { FaArrowDown, FaArrowRightLong, FaCalendar, FaTag, FaUser } from 'react-icons/fa6';
...
const Blog = () => {
  ...
  return (
    <section className="min-h-screen md:py-8 px-6 lg:px-[68px] md:px-10">
      {/* Search and Filter */}
      ...
      <section className="w-[85%] mx-auto">
        <table className='grid grid-cols-3 rounded-t-2xl bg-[#49A5EF] items-start px-6'>
