...
export function CreateInvoiceModal({ clientName, clientEmail, phone, onClose }: CreateInvoiceModalProps) {
  ...
  const updateItem = (id: string, field: keyof CreateInvoiceItem, value: any) => {
  ...
  const handleSubmit = () => {
    if (validate()) {
      ...
      toast.success('Create invoice submitted successfully!');
      onClose();
    }
  };
            ...
            <div className="mt-4 grid grid-cols-1 gap-4 md:grid-cols-3 px-4 md:px-6">
              ...
              <div>
                ...
                <select
                  ...
                  className="mt-1 w-full rounded-xl border border-slate-300 disabled:bg-slate-100 disabled:border-slate-100 disabled:cursor-not-allowed px-3 py-2 text-sm focus:border-primary focus:outline-none" disabled
                >
