  ...
  return (
    <AdminEnrolleesProvider>
      <EnrolleesStatsProvider>
        <div className="relative w-full bg-[#FAFAFA] pb-6 px-0 space-y-4 md:space-y-0">
          <Title title="Enrollees"/>
          <div className="flex gap-2 md:grid md:grid-cols-3 lg:gap-4 lg:ml-4 lg:mt-4 mx-auto overflow-x-auto w-full md:w-[96%] formDiv">
            <div>{enroll}</div>
            <div>{active}</div>
            <div>{inactive}</div>
          </div>
