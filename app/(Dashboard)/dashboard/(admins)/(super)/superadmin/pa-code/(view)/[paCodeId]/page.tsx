...
interface PageProps {
  params: Promise<{ paCodeId: string }>;
...
export default async function PaCodeViewPage({ params, searchParams }: PageProps) {
  const resolvedParams = await params;
  const paCodeId = resolvedParams.paCodeId;
  console.log('PaCodeViewPage resolved paCodeId:', paCodeId);
  console.log('PaCodeViewPage searchParams:', await searchParams);
