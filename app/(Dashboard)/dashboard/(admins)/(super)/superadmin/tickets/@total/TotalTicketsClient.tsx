...
interface TotalTicketsClientProps {
  initialData?: number;
}

const TotalTicketsClient: React.FC<TotalTicketsClientProps> = ({ initialData = 0 }) => {
  ...
  return (
    <section className='bg-[#49A5EF1A] w-44 md:w-full py-6 rounded-[15px] text-[#000000] flex items-center px-4 h-fit border-2 border-[#49A5EF]'>
        <div className='flex flex-col w-full'>
          <p className='text-[16px] md:text-[17px]'>Total Tickets</p>
...
export default TotalTicketsClient;