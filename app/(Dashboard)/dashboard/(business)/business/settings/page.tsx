...
export default function SettingsPage() {
  ...
  const { sessions, slaDocuments, paymentMethods, loading, error, removeSession, deleteSLADocument, deletePaymentMethod, addSLADocument, addPaymentMethod, changePassword } = useSettings()
      ...
      case "More":
        return (
          <MoreTab
            ...
            onDeleteSLADocument={deleteSLADocument}
            onDeletePaymentMethod={deletePaymentMethod}
            onUploadSLADocument={addSLADocument}
          />
        )
      default:
        return (
