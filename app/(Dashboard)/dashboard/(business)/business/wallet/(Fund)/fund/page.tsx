...
const Page = () => {
  ...
  return (
    <section className='p-4'>
      <Link href='/dashboard/business/wallet' className='border p-1 rounded-full inline-flex'>
          ...
          <p className='text-[18px]'>Fund your wallet for seamless healthcare payments</p>
            <div className='pt-8 pb-10 px-6 bg-[#FFFFFF] rounded-[10px] flex gap-10 flex-col' style={{height: '20rem'}}>
              ...
              <form action="" className='flex flex-col gap-6' onSubmit={handleSubmit}>
                ...
                <input type="submit" value={`${isSubmitting ? 'Sending...' : 'Fund Wallet'}`} className='btn py-2 rounded-2xl w-full cursor-pointer' disabled={isSubmitting}/>
              </form>
            </div>
        </div>
      </div>
