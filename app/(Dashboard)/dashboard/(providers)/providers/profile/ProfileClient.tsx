    ...
    <section className='py-6 px-6 md:p-8 bg-[#FFFFFF] rounded-[10px] md:w-[60%] space-y-8'>
      <div className='flex items-center justify-between'>
        <div className='flex space-x-2 lg:space-x-4 items-center flex-1 lg:w-fit'>
          <div className='md:p-8 p-6 h-fit w-fit rounded-full flex items-center justify-center bg-primary/60'>
            <p className='text-white text-[24px] md:text-[30px] font-bold'>
