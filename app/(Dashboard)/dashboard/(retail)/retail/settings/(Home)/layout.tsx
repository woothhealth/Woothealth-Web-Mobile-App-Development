          ...
          <div className="rounded-[15px] bg-gray-100 px-2 py-2 w-fit">
            <nav className="">
              <ul className="flex gap-4">
                ...
                <li onClick={() => router.push('/dashboard/retail/settings/billing')} className={`text-[14px] md:text-[16px] py-1 px-3 ${pathname === '/dashboard/retail/settings/billing' ? 'bg-[#FFFFFF] rounded-2xl' : ''}`}>Billing</li>
