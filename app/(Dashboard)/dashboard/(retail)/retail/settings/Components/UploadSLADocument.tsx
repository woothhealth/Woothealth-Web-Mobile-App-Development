...
export default function UploadSLADocument() {
  const [documents, setDocuments] = useState<SLADocument[]>([
    {
      id: '1',
      name: 'Service Level Agreement 2024.pdf',
    ...
    {
      id: '2',
      name: 'SLA Amendment Q1 2024.pdf',
  ...
  return (
    ...
    >
        <div className='flex flex-col space-y-6 bg-[#ffffff] p-8 rounded-[10px]'>
            ...
            {/* Upload Area */}
            <motion.div
                className="border-2 border-dashed border-gray-300 rounded-xl p-8 w-[80%] mx-auto text-center hover:border-blue-400 transition-colors cursor-pointer group"
                    ...
                    {selectedFile && (
                      <div className="w-full bg-gray-50 border border-gray-200 rounded-lg p-4 text-left">
                        ...
                        <button
                          ...
                          className="mt-4 w-full inline-flex items-center justify-center px-4 py-2 bg-green-600 text-white rounded-lg hover:bg-green-700 disabled:opacity-50"
                        >
