...
const page = () => {
  return (
    <section>
      <p className='mb-2 text-lg'>Manage your health insurance coverage and benefits</p>
    <div className='dsbGrad w-full py-6 text-[#FFFFFF] flex flex-col px-6 space-y-6 rounded-[10px]'>
      ...
      <div className='flex justify-between'>
        <div className='flex flex-col gap-1 bg-[#49A5EF] rounded-[10px] justify-between px-4 py-3 w-50'>
          <p className='text-[16px] w-20'>Monthly Premium</p>
          <h3 className='flex items-end text-[22px]'><TbCurrencyNaira className='text-4xl font-bold'/>34, 100</h3>
        </div>
        <div className='flex flex-col gap-1 bg-[#49A5EF] justify-between rounded-[10px] px-4 py-3 w-50'>
        ...
        <div className='flex flex-col justify-between gap-1 bg-[#49A5EF] rounded-[10px] px-4 py-3 w-50'>
          <p className='text-[16px]'>Next Renewal</p>
          <h3 className='text-[22px]'>Jan 10, 2025</h3>
        </div>
        <div className='flex flex-col gap-1 bg-[#49A5EF] rounded-[10px] justify-between px-4 py-3 w-50'>
          <p className='text-[16px]'>Plan Type</p>
          <h3 className='text-[22px] w-20'>Family Coverage</h3>
        </div>
      </div>
